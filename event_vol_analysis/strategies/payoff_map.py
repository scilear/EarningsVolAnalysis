...
from event_vol_analysis.strategies.structures import (
    ...
    Strategy,
    _snap_to_strike,
    make_broken_wing_call_butterfly,
    make_call_spread,
    make_call_ratio_spread,
    make_covered_call,
...
def _build_structure_catalog(
    *,
    ...
    catalog: dict[str, Strategy] = {
        ...
        "call_ratio_spread_102_107": make_call_ratio_spread(
            expiry=front_expiry,
            long_strike=call_2,
            short_strike=call_7,
            ratio=2,
        ),
        "broken_wing_call_butterfly_98_100_106": make_broken_wing_call_butterfly(
            expiry=front_expiry,
            lower_strike=put_2,
            short_strike=atm,
            upper_strike=call_7,
        ),
        "jade_lizard_96_90_106": make_jade_lizard(
            expiry=front_expiry,
            short_put_strike=put_4,
            long_put_strike=put_10,
            short_call_strike=call_7,
        ),
