...
Example usage:
    ...
    python -m event_vol_analysis.main --test-data

    # Use specific test scenario
    python -m event_vol_analysis.main --test-data --test-scenario high_vol

    # Save test data for later use
    python -m event_vol_analysis.main --test-data --save-test-data

    # Access snapshot for entry-condition testing
    from event_vol_analysis.data.test_data import generate_scenario
