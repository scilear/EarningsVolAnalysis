...
from event_vol_analysis.strategies.calendar import (
    build_calendar,
...
class TestRegistryStructuralInvariant:
    ...
    def test_mismatched_keys_raise_assertion(self) -> None:
        ...
        from event_vol_analysis.strategies.registry import (
            STRATEGY_CONDITIONS,
            STRATEGY_BUILDERS,
        )
...
class TestDteWindowConstants:
    ...
    def test_loader_uses_back3_constants(self) -> None:
        ...
        from event_vol_analysis.data.loader import _select_back3_expiry
