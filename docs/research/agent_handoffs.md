...
| `001_event_schema_foundation.md` | `019d6e01-66b8-7c81-9284-c7f4af8ec9b8` | `Poincare` | `gpt-5.3-codex` | `medium` | `running` | Strong architecture-sensitive schema task |
| `003_playbook_policy_engine.md` | `019d6e01-677b-7e11-a919-75b6d8095b49` | `Halley` | `gpt-5.3-codex` | `medium` | `running` | Strong policy/output contract task |
| `013_test_strategy_for_migration.md` | `019d6e06-6810-7390-bb07-b9d7c85b1d68` | `Maxwell` | `gpt-5.4-mini` | `medium` | `running` | Medium migration test-strategy task |
